 ...
 * 1. Create a new object in the blogPosts array above
 * 2. Include all required fields:
 *    - id: A unique identifier (increment from the last one)
 *    - date: The publication date
 *    - title: The post title
 *    - content: The main content (use backticks `` for multi-line content)
 * 3. Optional fields:
